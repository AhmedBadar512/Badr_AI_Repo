...
y_true = np.random.randint(0, num_labels - 1, (batch_size, label_length), dtype=np.int32)
...
x = tf.nn.ctc_greedy_decoder(tf.transpose(y_tmp, [1, 0, 2]), t_label_length)
print(x)
print(y_true)
